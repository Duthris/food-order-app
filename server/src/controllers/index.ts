...
import { restaurantRegister, restaurantLogin, 
    ...
    addFoodToMenu, getRestaurantMenusByRestaurant, removeFoodFromMenu, updateOrderStatus, getRestaurantOrder, getAverageRating
...
import { applyVoucherToBasket, getBasket, resetBasket, updateBasketWithSelectedFoods, removeFoodFromBasket, 
    addFoodToBasket, addMenuFoodsToBasket, addMenuToBasket, removeMenuFromBasket, removeVoucherFromBasket } from './basket.controller';
...
export { 
    ...
    getVoucher, getVouchers, addRatingToRetaurantForCompletedOrder, getRatingsForRestaurant, getRestaurants,
    getRestaurantsByTheirFoodsCategories,
    ...
    updateOrderStatus, getAverageRating,
